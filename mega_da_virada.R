...
mega <- function(n){
  ...
  return(message(c(paste0("A probabilidade de fazer uma quadra é de ",
                   ...
                   paste0("OU, em outras palavras (e de forma aproximada):"),"\n\n",
                   paste0("A probabilidade de fazer uma quadra é de 1 em ",
                          round(1/prob_quadra),";"),"\n",
                   paste0("A probabilidade de fazer uma quina é de 1 em ",
                          round(1/prob_quina),";"),"\n",
                   paste0("A probabilidade de acertar as seis dezenas é de 1 em ",
                          round(1/prob_sena),";"),"\n",
                   paste0("A probabilidade de ganhar algum prêmio é de 1 em ",
                          round(1/prob_algum_premio),".")
)))
}
